...
const calcularProcentajeScroll = ( event ) => {
    ...
    // estos valores son de la ventana
    // scrollTop: cuanto se ha desplazado hacia abajo, el ancho superior del documento
    // scrollHeight: altura total del documento
    // clientHeight: altura de la ventana visible
    const {
        scrollTop,
        scrollHeight,
        clientHeight
...
// Streams
// escucha el evento scroll del documento
// y emite un evento cada vez que se produzca
const scroll$ = fromEvent( document, 'scroll');
// scroll$.subscribe( console.log );

// calcularProcentajeScroll recibe el evento y devuelve un porcentaje
// el tap solo impirime el valor en consola, pero el map ya emite el nuevo valor
...
// nos suscribimos al observable, emite un porcentaje
// y actualizamos la barra de progreso
// cada vez que se emita un nuevo valor actualizando su ancho
